...
javascript:
	...
	node_modules/.bin/uglifyjs $(STATIC_JS)/lib/table_builder.js $(STATIC_JS)/src/oa_shared.js $(STATIC_JS)/src/*.js $(STATIC_JS)/src/studio/*.js > "$(STATIC_JS)/openassessment-studio.min.js"
